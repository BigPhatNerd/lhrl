...
const viewHalfMarathon = async (payload, workouts, slashOrHome, publicChannels) => {
...
array.push(staticSelect,
    ...
    const mapWorkouts = {
        ...
        view: {
            "type": "modal",
            "callback_id": "subscribe_to_half_marathon",
...
module.exports = viewHalfMarathon;
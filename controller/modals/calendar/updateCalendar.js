...
const updatedCalendarWorkouts = async (
    payload,
    viewId,
    workouts,
    slashOrHome
    ...
    var date =
        typeof payload.view.state.values?.modal_calendar?.modal_calendar
            ?.selected_date === "undefined" ||
        !payload.view.state.values.modal_calendar
            ? calendar_date
            : payload.view.state.values.modal_calendar.modal_calendar
                  .selected_date;
